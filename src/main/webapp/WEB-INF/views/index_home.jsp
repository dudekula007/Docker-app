                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">Mustafa</a>
                            <i class="brand_network"><small><small>Mustafa</small></small></i>
                        </div>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">We are here to help you for getting your dream job.
	    </p>
	    <p><strong>Address:</strong>  Flat no: 136-8-180,1st Floor,Adithya Residency, Begumpet, Hyderabad-16</p> 
	    <p><strong>Ph No: </strong>  +91-987654321</p>
		<p><strong>E-Mail ID :</strong>  devops1999@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2017 <a href="#"  target="_blank" class="w3-hover-text-green"> Mustafa.com</a></p>
</footer>
